...
<?php endforeach ?>
    ...
    <div class="container">
                ...
                <h2 class="section-heading text-center wow fadeIn" data-wow-duration="1s">Phàm Nhân Tu Tiên</h2>
                <h2 class="section-heading text-center wow fadeIn" data-wow-duration="1s">
                <button type="button" class="btn btn-success">Chương trước</button>
                <button type="button" class="btn btn-success">Chương sau</button>
                <h4 class="section-heading text-center wow fadeIn" data-wow-duration="1s">----------- Chapter 1 -----------</h4>
                <h4>"Anh ngố" trợn trừng hai mắt, nhìn chằm chằm vào nóc nhà được tạo thành từ cỏ dại và bùn trộn lẫn. Toàn thân hắn được trùm bởi một cái áo bông đã cũ, ố vàng, nhìn không còn ra hình dạng ban đâu, phảng phất tán phát ra một ít mùi ẩm mốc.
...
<h2 class="section-heading text-center wow fadeIn" data-wow-duration="1s">
                <button type="button" class="btn btn-success">Chương trước</button>
                <button type="button" class="btn btn-success">Chương sau</button></h2>
                <h1>
