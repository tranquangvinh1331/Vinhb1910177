...
<?php endforeach ?>
    ...
    <!-- Main Page Content --> 
    <div class="container">
        <section name="inner" class="inner-section section">
                <!-- SECTION HEADING -->
                ...
                <div class="inner-wrapper row">
                    <div class="col-md-12">
                        ...
                        <a href="/add.php" class="btn btn-primary" style="margin-bottom: 30px;">
                            <i class="fa fa-plus"></i> Thêm chapter</a>

                        <!-- Table Starts Here -->
                        <table name="Comics" class="table table-bordered table-responsive table-striped">
                            <thead>
                                <tr>
                                    <th>Số chaper</th>
                            ...
                            <?php foreach($Comics as $Comic): ?>
                            <tr>
<td><?=htmlspecialchars($Comic->getId())?></td>
...
<a href="/content.php?id=<?=$Comic->getId()?>"
class="btn btn-xs btn-success">
<i alt="view" class="fa fa-pencil"> view</i></a>
</td>
...
<?php endforeach ?>
                            ...
                            <div name="delete-confirm" class="modal fade" role="dialog">"
